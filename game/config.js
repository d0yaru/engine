...
class Map
{
	...
	//  [x,y,z,rx,ry,rz,sx,sy,sz,idImg,objType]
		[0,90,1000,   0,180,0,   2000,200,1,   0,0],// 0
		[0,90,-1000,   0,0,0,   2000,200,1,   1,0],// 1
		[1000,90,0,   0,-90,0,   2000,200,1,   2,0],// 2
		[-1000,90,0,   0,90,0,   2000,200,1,   3,0],// 3

		[0,0,0,   90,0,0,   2000,2000,1,   9,0],// 4 земля
		
		[-300,0,0,   90,30,0,   2000,1000,1,   6,0],// 5
		[0,0,-400,   60,0,30,   2000,1000,1,   10,0],// 6

		[0,0,0,   0,90,0,   100,100,1,   3,0],// 7
		[0,0,0,   0,0,0,   100,100,1,   2,0],// 8
		[0,0,50,   0,0,0,   100,100,1,   1,0],// 9

		[2000,0,0,90,0,0,2000,2000,1,6,0],
		[-2000,0,0,90,0,0,2000,2000,1,6,0],
		[0,0,2000,90,0,0,2000,2000,1,6,0],
		[0,0,-2000,90,0,0,2000,2000,1,6,0],
		
		[2000,0,2000,90,0,0,2000,2000,1,6,0],
		[-2000,0,2000,90,0,0,2000,2000,1,6,0],
		[-2000,0,-2000,90,0,0,2000,2000,1,6,0],
		[2000,0,-2000,90,0,0,2000,2000,1,6,0],

		[1500,70,1500,0,0,0,100,200,1,3,0],
		[-1200,70,-1500,0,0,0,100,200,1,4,0],
		[-1400,70,1500,0,0,0,100,200,1,5,0],
		[1300,70,-1500,0,0,0,10,10,1,8,0],
	];
	//--------------------------------------------------------------------------
	constructor() {}
}
